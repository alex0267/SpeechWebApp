...
const captcha_site_key = isDev ? "6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI" : production_client_key;
...
const Form = () => {
    ...
    const onSubmit = async () => {
        if (captcha == "") {
            ...
            const r = await fetch(`${apiHost}/api/v0.1/delete_record/${uuid}?captcha_response=${captcha}`, {
                method: "DELETE",
            });
